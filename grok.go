...
func init() {
	filters.Register("grok", newGrokFilter)
}
...
func newGrokFilter(options utils.InterfaceMap) (filters.Filter, error) {
...
func (f *GrokFilter) Filter(batch []*event.Event, matchedFunc filters.MatchFunc) []*event.Event {
